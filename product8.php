<?php
$thisproduct='Waterfalls amid cities';
...
<head>
    ...
    <title>Enjoy the waterfalls amid cities.</title>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product8/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product8/2.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product8/1.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2>Enjoy the waterfalls amid cities.</h2>
                    Enjoy the waterfalls amid cities.
<br><br>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $300</p>
