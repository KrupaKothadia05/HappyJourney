<?php
$thisproduct='Feel the rocks and water';
...
<head>
    ...
    <title>Stay in between mountains and waters.</title>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product3/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product3/2.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product3/3.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product3/1.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2> Stay in between mountains and waters.</h2>
                    
                    Stay in between mountains and waters.
<br><br>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $540</p>
