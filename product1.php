<?php
$thisproduct='Camp Stay in Forest';
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product1/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product1/2.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product1/4.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product1/5.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product1/1.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2> This Package is for someone who wants to enjoy the night under trees.</h2>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $200</p>
