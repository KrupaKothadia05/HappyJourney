...
<head>
    ...
    <title>Stay in Turkey and Greece and experience the beauty of this two extremely magnificent places.</title>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product4/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product4/2.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product4/3.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product4/2.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2> Stay in Turkey and Greece and experience the beauty of this two extremely magnificent places.</h2>
                    Stay in Turkey and Greece and experience the beauty of this two extremely magnificent places.
                    <br><br>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $600</p>
