<?php
$thisproduct='Natural Waterfalls';
...
<head>
    ...
    <title>Enjoy the beautfiul waterfalls</title>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product6/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product6/2.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product6/3.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product6/1.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2>Enjoy the beautfiul waterfalls</h2>
                    Enjoy the beautfiul waterfalls
                    <br><br>
                    <div class="rating">
