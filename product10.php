...
<head>
    ...
    <title>Experience a stay in and under water.</title>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="slider">
                    <div class="product">
                        ...
                        <img src="images/product10/1.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product10/2.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product10/4.jpeg" alt="" onclick="clickme(this)">
                        <img src="images/product10/5.jpeg" alt="" onclick="clickme(this)">

                    </div>
                    <div class="preview">
                        <img src="images/product10/1.jpeg" id="imagebox" alt="">
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2>Experience a stay in and under water.</h2>
                    Experience a stay in and under water.
<br><br>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"></p>
